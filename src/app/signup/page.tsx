...
export default function SignupPage({ onToggleForm, onSuccess }: SignupPageProps) {
  return (
    <div className="min-h-screen bg-[#07060b] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-1/4 w-[500px] h-[300px] bg-fuchsia-500/10 blur-[120px] rounded-full pointer-events-none" />
      <div className="absolute bottom-0 left-1/4 w-[500px] h-[300px] bg-indigo-500/10 blur-[120px] rounded-full pointer-events-none" />
      ...
      <SignupForm onToggleForm={onToggleForm} onSuccess={onSuccess} />
    </div>
  );
}
