...
interface GafferProfilePageProps {
  profile: UserProfile;
  squadsList: Squad[];
...
export default function GafferProfilePage({
  profile,
  squadsList,
  onUpdateProfile,
  onLoadSquad,
  onDeleteSquad,
}: GafferProfilePageProps) {
  return (
    <div id="gaffer-profile-page-root" className="flex flex-col gap-8 w-full">
      {/* Page Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b-2 border-black/40 pb-4">
        <div>
          ...
          <p className="text-xs text-gray-400 font-mono mt-1 uppercase tracking-wide">
            Manage your personal street bio, tactical badges, and overview your general Win Rate.
          </p>
        </div>
      </div>
